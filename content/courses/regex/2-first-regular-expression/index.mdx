...
Let's say we have a simple string like "my name is Dillion". And we want to write a pattern that matches "name" in this string. Our regex pattern will be simply:
name
